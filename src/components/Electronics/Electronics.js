...
function Electronics(props) {
    ...
    const [electronics, setProducts] = useState([]);

    const{AddToCart,favo,FavItem}=props

    useEffect(() => {
        fetch("https://fakestoreapi.com/products/category/electronics").then(res => res.json()).then(res => {
            setProducts(res)
        })
    }, []);
